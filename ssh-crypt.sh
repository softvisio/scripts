...
# echo "text-to-encrypt" | bash <(curl -fsS "https://raw.githubusercontent.com/softvisio/scripts/main/ssh-crypt.sh") encrypt $GITHUB_USERNAME

# echo "text-to-decrypt" | bash <(curl -fsS "https://raw.githubusercontent.com/softvisio/scripts/main/ssh-crypt.sh") decrypt $GITHUB_USERNAME
