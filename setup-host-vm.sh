...
function _import_gpg_keys() {
    ...
    script=$(curl -fsS "https://raw.githubusercontent.com/zdm/dotfiles-public/main/gpg/restore-dzagashev@gmail.com.sh") && bash <(echo "$script")
    ...
    script=$(curl -fsS "https://raw.githubusercontent.com/zdm/dotfiles-public/main/gpg/restore-deb@softvisio.net.sh") && bash <(echo "$script")

    script=$(curl -fsS "https://raw.githubusercontent.com/zdm/dotfiles-public/main/gpg/restore-public-keys.sh") && bash <(echo "$script")
}
